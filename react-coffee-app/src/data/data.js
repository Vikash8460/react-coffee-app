export const data = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1623593721974-f39b78528626?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80",
      showMore: false,
    },
    {
      id: 6,
      name: "Protection against Alzheimer’s",
      text: "This degenerative, debilitating disease appears to be increasing in frequency although this is certainly in part due to more people reaching advanced ages. Research is ongoing, but many gaps in scientific understanding remain unplugged. Whether or not coffee drinkers have less chance of developing Alzheimer’s disease is one of the issues under investigation. Current findings lend some support to claims coffee drinking might lower the risk, but much more research is needed to draw definite conclusions.",
      image:
    ...
    {
      id: 7,
      name: "Who needs performance-boosting drugs?",
      text: "Anyone who follows the athletics news has heard about the recent scandals involving illegal drugs. A number of international athletes have been disqualified for using performance-boosting drugs to help them win competitions. If only they knew about an alternative but legal way to improve their track performance. Certain researchers claim that if athletes drink coffee before they exercise this stimulus booster can improve their abilities by at least ten percent. These researchers argue that coffee leads to higher oxygen consumption while exercising and it encourages the body to break up fat into energy.",
      image:
        "https://images.unsplash.com/photo-1475296204602-08d15839e95f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80",
      showMore: false,
    },
    {
      id: 8,
      name: "A boost to mental health",
      text: "In addition to creating physical energy, is it possible that coffee drinking also contributes to emotional wellbeing? Its role as a relaxant is popular knowledge, but some studies suggest it goes much further than this. Research done by the Harvard School of Public Health indicates that women who drank four or more cups per day reduce their risk of developing depression by a fifth. Another study suggested that regular coffee drinkers are less likely to become suicidal.",
      image:
        "https://images.unsplash.com/photo-1514163161321-f4f7c2a90296?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80",
      showMore: false,
    },
    {
      id: 9,
      name: "Decreases risks of developing heart disease",
      text: "Heart disease is now a major cause of death in developed countries. Anything that could reduce the risks of developing this disease is certain to receive an enthusiastic welcome. The humble cup of coffee might be just what is needed according to a study made in Korea. These researchers found that three cups per day is enough to lower the chances of developing heart disease. European and American scientists point out how dietary differences between their countries and Korea raise questions about the applicability of this research in their societies.",
      image:
        "https://images.unsplash.com/photo-1507915135761-41a0a222c709?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1171&q=80",
      showMore: false,
    },
    {
      id: 10,
      name: "Helps prevent Parkinson's disease",
      ...
      image:
        "https://images.unsplash.com/photo-1510083300914-5ffac797d9d2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80",
      showMore: false,
    },
  ];