    ...
    <section className="about-section">
      <>
        ...
        <p className="par-about">
          ...
          beans. The story goes that that Kaldi discovered coffee after he
          noticed that after eating the berries from a certain tree, his goats
          became so energetic that they did not want to sleep at night. Kaldi
          reported his findings to the abbot of the local monastery, who made a
          drink with the berries and found that it kept him alert through the
          long hours of evening prayer. The abbot shared his discovery with the
          other monks at the monastery, and knowledge of the energizing berries
          began to spread. As word moved east and coffee reached the Arabian
          peninsula, it began a journey which would bring these beans across the
          globe.
        </p>
        ...
        <p className="par-about">
          ...
          change the American drinking preference to coffee. "Coffee - the
          favorite drink of the civilized world." - Thomas Jefferson
        </p>

        <h3>Plantations Around the World</h3>
        <hr></hr>
        <p className="par-about">
